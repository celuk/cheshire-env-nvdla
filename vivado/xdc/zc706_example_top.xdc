...
set_property LOC W21 [get_ports {led[1]}]

# Bank: 33 - GPIO_LED_CENTER
set_property DRIVE 12 [get_ports {led[2]}]
set_property SLEW SLOW [get_ports {led[2]}]
set_property IOSTANDARD LVCMOS15 [get_ports {led[2]}]
set_property LOC G2 [get_ports {led[2]}]

# Bank: 11 - GPIO_LED_LEFT
set_property DRIVE 12 [get_ports {led[3]}]
set_property SLEW SLOW [get_ports {led[3]}]
set_property IOSTANDARD LVCMOS25 [get_ports {led[3]}]
set_property LOC Y21 [get_ports {led[3]}]
